...
%%% Dont know wtf this is :/ Took it from Insecticide.pdf
```{r}
library(car)
library(RcmdrMisc)
residualPlot(logReg,smooth=F)

plot(df_enrolled$age,df_enrolled$severe)

plot(resid(logReg,type="pearson"),df_enrolled$severe)

lines(df_enrolled$age,predict(logReg,type="response"), smooth=F)
